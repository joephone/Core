...
public class ResUtils {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(CoreApp.getInstance(), id);
    }
    ...
    public static int getColor(@ColorRes int id) {
        return ContextCompat.getColor(CoreApp.getInstance(), id);
    }
    ...
    public static String getAssets(String fileName) {
        ...
        try {
            AssetManager assetManager = CoreApp.getInstance().getAssets();
